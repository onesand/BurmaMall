...
public class AutoMaticPageGridView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        btn_res = array.getResourceId(R.styleable.AutoMaticPageGridView_auto_button, R.drawable.gridview_selector);//btn的样式
    ...
    public void setAdapter(BaseAutoAdapter baseAdapter) {
        ...
        } else if ((adapter.getCounts() / (column * lines)) > 0) {
    ...
    private void addRadioButton(int pages) {
        for (int i = 0; i < pages; i++) {
            ...
            radioButton.setPadding(10, 5, 10, 5);//间距
